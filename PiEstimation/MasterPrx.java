...
{
    default int requestPiEstimation(int totalPoints, int workers)
    {
        return requestPiEstimation(totalPoints, workers, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int requestPiEstimation(int totalPoints, int workers, java.util.Map<String, String> context)
    {
        return _iceI_requestPiEstimationAsync(totalPoints, workers, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> requestPiEstimationAsync(int totalPoints, int workers)
    {
        return _iceI_requestPiEstimationAsync(totalPoints, workers, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> requestPiEstimationAsync(int totalPoints, int workers, java.util.Map<String, String> context)
    {
        return _iceI_requestPiEstimationAsync(totalPoints, workers, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_requestPiEstimationAsync(int iceP_totalPoints, int iceP_workers, java.util.Map<String, String> context, boolean sync)
    {

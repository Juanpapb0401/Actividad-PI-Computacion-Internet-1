...
{
    default int calculatePoints(int totalPoints)
    {
        return calculatePoints(totalPoints, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int calculatePoints(int totalPoints, java.util.Map<String, String> context)
    {
        return _iceI_calculatePointsAsync(totalPoints, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> calculatePointsAsync(int totalPoints)
    {
        return _iceI_calculatePointsAsync(totalPoints, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> calculatePointsAsync(int totalPoints, java.util.Map<String, String> context)
    {
        return _iceI_calculatePointsAsync(totalPoints, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_calculatePointsAsync(int iceP_totalPoints, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "calculatePoints", null, sync, null);
